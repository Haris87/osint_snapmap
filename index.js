...
snapMap
  .getPlaylist(37.943026900072255, 23.70990052854298, 500, 20)
  .then((playlist) => {
    console.log(playlist.elements ? playlist.elements.length : 0);
    fs.writeFileSync("./playlist.json", JSON.stringify(playlist.elements));
  });
...
// snapMap
//   .getSearchCards("San Francisco", 37.787975, -122.407515, 12)
//   .then(function (searchCards) {
